...
$html .= '      <span><input id="ld_abstand" class="input_box txt_inp" value="'.$this->json['abstand'].'" /> px</span>'.CR;
$html .= '   </div>'.CR;

$html .= '   <div class="buttonzeile">';
$html .= '      <div class="button button_left" onclick="Multibox.close();">abbrechen</div>';
$html .= '      <div class="button_ci button_center" onclick="Livedesigner.saveAbstand();">speichern</div>';
$html .= '   </div>';
$html .= '</div>'.CR;
