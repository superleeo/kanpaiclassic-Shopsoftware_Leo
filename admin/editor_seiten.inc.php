...
// Editor-Konfiguration Menü / Untermenüs Seiten
...
<script>
// Seiten / Design-Template /
function initEditor1() {
   $('textarea.edit_schmal').tinymce({
...
function initEditor2() {
   ...
   $('textarea.edit_breit').tinymce({
      ...
      schema     : "html5",
      statusbar  : false,
<?php if (get_class() == 'KANPAICLASSIC\KANPAICLASSIC_Design_template') { ?>
      height     : 200,
<?php } else if (get_class() == 'KANPAICLASSIC\KANPAICLASSIC_modulLivedesigner') { ?>
      height     : 180,
<?php } else { ?>
      height     : 350,
<?php } ?>
