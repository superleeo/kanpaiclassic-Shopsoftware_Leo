...
// /admin/editor_seiten.inc.php
// /admin/editor_systemtexte.inc.php
// Module musikplayer_editor.inc.php
// Modul portal_editor.inc.php
// Modul editor_extended.inc.php
...
<script>
// Articles - Editor Artikel/Kategorien 2-spaltig
$(function() {
   $('textarea.editorarea2').tinymce({
      ...
      schema     : "html5",
      statusbar  : false,
<?php if($editor_mode == 'article') { ?>
      height     : 400,
      width      : 'auto',
<?php } ?>
<?php if($editor_mode == 'categories') { ?>
      height     : 280,
      width      : 'auto',
      statusbar  : false,
<?php } ?>
      ...
      menu: {
             edit  : {title: 'Edit', items: 'undo redo | cut copy paste pastetext | visualblocks formats template'},
             table : {title: 'Table', items: 'inserttable, tableprops, deletetable, cell, row, column'},
             insert: {title: 'Insert', items: 'media, image, link, unlink | charmap, hr, anchor, pagebreak, insertdatetime, nonbreaking,'}
      },

      toolbar1     : "fontselect | fontsizeselect | bold italic | forecolor backcolor",
      toolbar2     : "cut copy paste | alignleft aligncenter alignright alignjustify | preview | removeformat | code",
      ...
      ?>
//      valid_styles: {
//         "*": "border,width,height,padding,margin,float,display,position,opacity,color,background,background-color,font,font-size,font-family,insert,text-align"
//      },
...
// Editor Artikel/Kategorien 1-Spaltig
$(function() {
   $('textarea.editorarea').tinymce({
      script_url : admin_url+'/js/tinymce/tinymce.gzip.php',
      theme      : "modern",
      branding   : false,
      language   : "de",
      ...
      toolbar1: "fontselect | fontsizeselect | bold italic underline | forecolor backcolor",
      toolbar2: "undo redo | cut copy paste | alignleft aligncenter alignright alignjustify | bullist numlist | outdent indent | preview | removeformat | code",
