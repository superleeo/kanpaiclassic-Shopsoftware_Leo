...
//         $beschreibung = str_replace($wt, $wt.$wt, $beschreibung);
         ...
         $csv .= $wt.$this->_checkPict($info[$i]->pict02, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict03, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict04, $picurl).$wt.$trenner;        // p_image.1

         $csv .= $wt.$this->_checkPict($info[$i]->pict05, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict06, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict07, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict08, $picurl).$wt.$trenner;        // p_image.1
         $csv .= $wt.$this->_checkPict($info[$i]->pict01, $picurl).$wt.$trenner;        // p_image.1
