...
// deu_im Link      $xml .= '   <link><![CDATA['.$picurl.(defined('CONF_USE_HTACCESS') ? '' : '/index.php').'/deu_'.$info[$i]->artikel_id.'/'.urlencode($info[$i]->name).']]></link>'.CR;
      $xml .= '   <link><![CDATA['.$picurl.(defined('CONF_USE_HTACCESS') ? '' : '/index.php').'/'.$info[$i]->artikel_id.'/'.urlencode($info[$i]->name).']]></link>'.CR;
      $xml .= '   <bildlink>'.($info[$i]->pict01 == ''   || $info[$i]->pict01 == 'nopic.png' ? '' : (strstr($info[$i]->pict01, 'http') !== false ? $info[$i]->pict01 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict01.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink2>'.($info[$i]->pict02 == ''  || $info[$i]->pict02 == 'nopic.png' ? '' : (strstr($info[$i]->pict02, 'http') !== false ? $info[$i]->pict02 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict02.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink3>'.($info[$i]->pict03 == ''  || $info[$i]->pict03 == 'nopic.png' ? '' : (strstr($info[$i]->pict03, 'http') !== false ? $info[$i]->pict03 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict03.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink4>'.($info[$i]->pict04 == ''  || $info[$i]->pict04 == 'nopic.png' ? '' : (strstr($info[$i]->pict04, 'http') !== false ? $info[$i]->pict04 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict04.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink5>'.($info[$i]->pict05 == ''  || $info[$i]->pict05 == 'nopic.png' ? '' : (strstr($info[$i]->pict05, 'http') !== false ? $info[$i]->pict05 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict05.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink6>'.($info[$i]->pict06 == ''  || $info[$i]->pict06 == 'nopic.png' ? '' : (strstr($info[$i]->pict06, 'http') !== false ? $info[$i]->pict06 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict06.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink7>'.($info[$i]->pict07 == ''  || $info[$i]->pict07 == 'nopic.png' ? '' : (strstr($info[$i]->pict07, 'http') !== false ? $info[$i]->pict07 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict07.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink8>'.($info[$i]->pict08 == ''  || $info[$i]->pict08 == 'nopic.png' ? '' : (strstr($info[$i]->pict08, 'http') !== false ? $info[$i]->pict08 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict08.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink9>'.($info[$i]->pict09 == ''  || $info[$i]->pict09 == 'nopic.png' ? '' : (strstr($info[$i]->pict09, 'http') !== false ? $info[$i]->pict09 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict09.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink10>'.($info[$i]->pict10 == '' || $info[$i]->pict10 == 'nopic.png' ? '' : (strstr($info[$i]->pict10, 'http') !== false ? $info[$i]->pict10 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict10.'.jpg')).'</bildlink>'.CR;
      $xml .= '   <bildlink11>'.($info[$i]->pict11 == '' || $info[$i]->pict11 == 'nopic.png' ? '' : (strstr($info[$i]->pict11, 'http') !== false ? $info[$i]->pict11 : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict11.'.jpg')).'</bildlink>'.CR;
