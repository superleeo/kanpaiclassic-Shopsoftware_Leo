...
// deu_im Link      $csv .= $wt.$shopurl.(defined('CONF_USE_HTACCESS') ? '' : '/index.php').'/deu_'.$info[$i]->artikel_id.'/'.urldecode($info[$i]->name).$wt.$trenner;
      ...
      $csv .= $wt.($info[$i]->pict01 == '' || $info[$i]->pict01 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict01.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict02 == '' || $info[$i]->pict02 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict02.'.jpg').$wt.$trenner;

      $csv .= $wt.($info[$i]->pict03 == '' || $info[$i]->pict03 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict03.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict04 == '' || $info[$i]->pict04 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict04.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict05 == '' || $info[$i]->pict05 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict05.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict06 == '' || $info[$i]->pict06 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict06.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict07 == '' || $info[$i]->pict07 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict07.'.jpg').$wt.$trenner;

      $csv .= $wt.($info[$i]->pict08 == '' || $info[$i]->pict08 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict08.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict09 == '' || $info[$i]->pict09 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict09.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict10 == '' || $info[$i]->pict10 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict10.'.jpg').$wt.$trenner;
      $csv .= $wt.($info[$i]->pict11 == '' || $info[$i]->pict11 == 'nopic.png' ? '' : $picurl.'/'.CONF_PICT_PATH.$info[$i]->pict11.'.jpg').$wt.$trenner;
