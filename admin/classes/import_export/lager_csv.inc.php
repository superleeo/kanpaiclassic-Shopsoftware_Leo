...
if ($mode == 'import') {
   ...
   for ($i = 0; $i <count($artikel); $i++) {
      ...
      if ($act_artikel[0] == 'id' || $act_artikel[0] == 'art_nr') {
         if ($act_artikel[0] == 'id') {
            $has_id = true;
         }
      ...
      if ($has_id) {
         if ($act_artikel[0] == '' || (int)$act_artikel[0] == 0) {
            continue;
         }
