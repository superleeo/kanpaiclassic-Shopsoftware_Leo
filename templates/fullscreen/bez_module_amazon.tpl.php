      ...
      <div class="col_single">
         <form id="form_bestellt" method="post" action="<?php echo SHOP_URL_IDX; ?>/bestellt">
            ...
            <div class="line">
               ...
               <div class="line_right fliesstext text_normal"><img src="<?php echo $params->templateurl . '/images/system/btn_preis_nl_' . $params->selected_lang . '.jpg'; ?>" /></div>
               <?php } else { ?>
               <div class="line_right fliesstext text_normal"><?php echo KANPAICLASSIC\KANPAICLASSIC\Helper::number_format($gesamt_show, 2, ',', '.'). ' '.$params->waehrung; ?></div>
               <?php } ?>
            </div>
            ...
            <div class="line">
               <div id="button1" class="bg_button col_button text_gross button55" onclick="Royalart.checkAmazon();" style="width:100%; display:none;"><?php echo $text->get('warenkorb', 'senden'); ?><?php echo (defined('CONF_PAYPAL_SANDBOX') ? ' (Sandbox)' : ''); ?></div>
            </div>
         </form>
      </div>
   </div>
